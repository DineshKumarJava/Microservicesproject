...
import com.ecom.din.product.init.IntializeData;
...
@EnableSwagger2
public class ProductMApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		intit.intializeProductcategory();
	}
